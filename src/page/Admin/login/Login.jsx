...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await apiCall.adminLogin("auth/login", {
                email: email,
                password: password,
            });
            ...
            handleError(error, setError); // Pass the error to handleError
        }
    };
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 w-full max-w-4xl p-4">
                ...
                <div className="w-full rounded-r-lg p-8 space-y-6 bg-white shadow-md">
                    ...
                    <form className="space-y-4 flex items-center flex-col" onSubmit={handleSubmit}>
                        ...
                        <p>Or</p>
                        <button className="px-4 py-2 border flex gap-2 border-black rounded-lg text-black hover:border-slate-400 hover:text-slate-900 hover:shadow transition duration-150">
                            <img
                                className="w-6 h-6"
